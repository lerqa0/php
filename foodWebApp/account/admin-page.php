...
if ($_SESSION['admin_sid'] == session_id()) {
                ...
                <div class="nav-wrapper">
                    <ul class="left">
                        <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img
                                            src="images/logo.png" alt="logo"></a> <span class="logo-text">Logo</span>
                            </h1></li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="wrapper">
            ...
            <section id="content">
                ...
                <div class="container">
                    ...
                    <td>
                    <form action="routers/delete-item.php" method="post">
                        <input type="hidden" name="id" value="'. $row['id'] .'">
                        <button class="btn cyan waves-effect waves-light right" type="submit" onclick="return confirm("Sunteti sigur ?")">delete</button></td>
                    </form>
                    </tr>';
                                    }
                                    ?>
    ...
    <footer class="page-footer">
        <div class="footer-copyright">
            <div class="container">
                <span>Copyright © 2024 Lera. All rights reserved.</span>
